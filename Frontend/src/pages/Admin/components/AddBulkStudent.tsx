      ...
      <DialogContent className="bg-black bg-opacity-80 text-white max-w-xl backdrop-blur-xl border border-zinc-700">
        <DialogHeader>
          ...
          <DialogDescription className="text-zinc-400">
            Upload an Excel (.xlsx or .xls) file. Each row should include:
            <br />
            <span className="text-white font-medium">Full Name, Class, Email, Phone</span>.
            <br />
            Optionally, you can include <strong>Tuition, Transport, and Kit</strong> columns
            to override default fee structure.
          </DialogDescription>
        </DialogHeader>
