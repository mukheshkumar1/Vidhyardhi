...
const StaffProfileImage: React.FC<StaffProfileImageProps> = ({ staffId, currentImage }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://vidhyardhi.onrender.com/api/admin/staff/${staffId}/update-profile-picture`,
        {
          method: "PUT",
          credentials: "include",
          body: formData,
      ...
      toast.error("Failed to upload staff profile picture.");
    } finally {
      setUploading(false);
    }
  };
